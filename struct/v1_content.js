...
const versiontype = config["ERA-V1"];

if (versiontype.Alpha == true) {
  if (versiontype.Beta == true) {
    if (versiontype.Release == true) {
      console.log(
        "Error at serverconfig.json, selected to many versions!\n\n\nShutting down the server.."
      );
      process.exit();
    }
  }
...
if (versiontype.Beta == true) {
  var contentpagesnotice = "Beta!";
}
if (versiontype.Release == true) {
  var contentpagesnotice = "Release";
}
const contentpagesnoticeSUB = `${contentpagesnotice} ${version}`;
    ...
    loginmessage: {
      ...
      loginmessage: {
        ...
        message: {
          ...
          title: `Project Era ${version}`,
          body: "DLL by: danii#0427\nJoin us at: dsc.gg/erafn\n\nEnjoy!!",
        },
      },
    ...
    subgameselectdata: {
      ...
      battleRoyale: {
        ...
        message: {
          ...
          body: {
            ...
            ru: "Fortnite: Battle Royale",
            ko: "Fortnite: Battle Royale",
            en: "Fortnite: Battle Royale",
            it: "Fortnite: Battle Royale",
            fr: "Fortnite: Battle Royale",
            es: "Fortnite: Battle Royale",
            ar: "Fortnite: Battle Royale",
            ja: "Fortnite: Battle Royale",
            pl: "Fortnite: Battle Royale",
            "es-419": "Fortnite: Battle Royale",
            tr: "Fortnite: Battle Royale",
          },
          spotlight: false,
        },
      },
      ...
      saveTheWorld: {
        ...
        message: {
          ...
          body: {
            de: "Fortnite: Save the World is not available with Project Era.",
            ru: "Fortnite: Save the World is not available with Project Era.",
            ko: "Fortnite: Save the World is not available with Project Era.",
            en: "Fortnite: Save the World is not available with Project Era.",
            it: "Fortnite: Save the World is not available with Project Era.",
            fr: "Fortnite: Save the World is not available with Project Era.",
            es: "Fortnite: Save the World is not available with Project Era.",
            ar: "Fortnite: Save the World is not available with Project Era.",
            ja: "Fortnite: Save the World is not available with Project Era.",
            pl: "Fortnite: Save the World is not available with Project Era.",
            "es-419":
              "Fortnite: Save the World is not available with Project Era.",
            tr: "Fortnite: Save the World is not available with Project Era.",
          },
          spotlight: false,
        },
      },
        ...
        messages: [
          {
            hidden: false,
            _type: "CommonUI Simple Message Base",
            title: `${contentpagesnotice}`,
            body: `Era ${contentpagesnoticeSUB} by danii#5000 - Not a Robot#6932 - onze#3303 - Kyiro#7884`,
            spotlight: true,
          },
        ],
      },
