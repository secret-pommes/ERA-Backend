...
// Version of EraV1
var version = config["ERA-V1"].Version;
var versiontype = config["ERA-V1"];

// Content-Pages version checking
...
var contentpagesnoticeSUB = `${contentpagesnotice} ${version}`


// Version check (Era V1)
app.get("/VersionRequest", (req, res) => {
  res.send(version);
});
